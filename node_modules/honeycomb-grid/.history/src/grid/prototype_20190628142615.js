...
export function pointWidth() {
  ...
  const { 0: first, length, [length - 1]: last } = this[0].isPointy()
    ? [...this].sort((a, b) => b.s - a.s || a.q - b.q)
    : [...this].sort((a, b) => a.q - b.q)

  return last.toPoint().x - first.toPoint().x + this[0].width()
}
...
export function pointHeight() {
  ...
  return last.toPoint().y - first.toPoint().y + this[0].height()
}
