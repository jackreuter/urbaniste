...
export function ringFactory({ Grid, Hex }) {
  return function ring({ center, radius }) {
    ...
    // let currentHex = center.add(Hex(-radius + (center.y % 2 === 0 ? 2 : 2), -radius))
    console.log(Math.round(radius / 2), offset)
    let currentHex = center.add(Hex(-radius + Math.round(radius / 2), -radius))
