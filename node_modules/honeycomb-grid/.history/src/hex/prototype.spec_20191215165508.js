...
describe.only('nudge', function() {
  it('returns the current hex with a tiny offset on each cube coordinate', function() {
    ...
    expect(hex).to.contain({ q: 1.000001, r: -2.999999, s: 1.999999 })
    // expect(result.q).to.be.closeTo(1, 0.000002)
    // expect(result.r).to.be.closeTo(-3, 0.000002)
    // expect(result.s).to.be.closeTo(2, 0.000002)
    // const hex = Hex({ q: 1, r: -3, s: 2 })
    // expect(hex.nudge().cube()).to.eql({ q: 0.999999, r: -2.999999, s: 2.000001 })
